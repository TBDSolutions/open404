...
par(mar=c(1,1,1,7))
hclust_ward %>%
  set("labels_col", value = c("skyblue", "orange", "red","#559E54","#700CBC","#FCBA12","#236AB9"), k=7) %>%
  set("branches_k_color", value = c("skyblue", "orange", "grey","#559E54","#700CBC","#FCBA12","#236AB9"), k = 7) %>%
...
rect.dendrogram( hclust_ward, k=7,which = 3,horiz = TRUE,col=rgb(0.1, 0.2, 0.1, 0.1),
                 border = 1,lty = 5)
title("CMH Cluster Groupings",font.main= 4, col.main= "#292F33")
